        ...
        <Form onSubmit={formik.handleSubmit}>
          ...
          <Form.Group controlId="formik_type">
            ...
            <Field
              ...
              name="type"
            />
            <ErrorMessage name="type" className="text-danger" />
          </Form.Group>
          ...
          <Form.Group controlId="formik_issues">
            ...
            <Field
              ...
              name="issue"
            />
            <ErrorMessage name="issue" className="text-danger" />
          </Form.Group>
          ...
          <Form.Group controlId="formik_langGrants">
            ...
            <Field
              ...
              name="langGrants"
            />
            <ErrorMessage name="langGrants" className="text-danger" />
          </Form.Group>
          ...
          <Form.Group controlId="formik_funders">
            ...
            <ErrorMessage name="funders" className="text-danger" />
          </Form.Group>
          ...
          <Form.Group controlId="formik_beneficiaries">
            ...
            <ErrorMessage name="beneficiaries" className="text-danger" />
          </Form.Group>
          ...
          <Form.Group id="formik_street1">
            ...
            <ErrorMessage name="street1" className="text-danger" />
          </Form.Group>

          <Form.Group id="formik_street2">
            <Form.Label>Street 2</Form.Label>
            <Field name="street2" type="text" as={Form.Control} />
            <ErrorMessage name="street2" className="text-danger" />
          </Form.Group>
