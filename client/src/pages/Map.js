...
class Map extends Component {
  ...
  filterOnClick(filter) {
    ...
    this.setState({
      ...
      map: {
        viewport: {
          // 1) need to store polygon for common cities
          // 2) check for match between filter and common cities
          // 3) if match, this.setState({map:{viewport:{
          // compute center of polygon? seems terrible
          // is there a way to
          // }}})
          fitBounds: [
            [
